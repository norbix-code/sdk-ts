...
import { AccessTokenModule } from '../../src/hub/access_token.js';
 ...
 *
 * Tests for hub.accessToken (1 endpoints).
 *
...
describe('hub.accessToken', () => {
  it('module exposes 1 method(s)', () => {
    ...
    const ns = (norbix.hub as unknown as Record<string, unknown>)['accessToken'] as Record<
      string,
      unknown
    >;
