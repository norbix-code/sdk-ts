...
**391 endpoints across 19 modules.** Click a module
...
| [`account`](./account.md) | 60 | Account profile, status, verification, team invites, and Stripe billing portal. Most write endpoints require `accountId` on the client. |
| [`ai`](./ai.md) | 14 |  |
...
| [`code`](./code.md) | 28 |  |
| [`database`](./database.md) | 46 | Database schemas, integrations, triggers, taxonomies, and module on/off switches. For data-level CRUD on collections see `api.database`. |
