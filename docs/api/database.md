...
**Request DTO**: `CodeMashApi2.FindTaxonomyTreeRequest`
...
const result = await norbix.api.database.findTaxonomyTree({
  // See CodeMash type for the full request shape.
});
// → typed as CodeMashApi2.FindTaxonomyTreeResponse
```
...
**Request DTO**: `CodeMashApi2.FindTermTreeRequest`
...
// → typed as CodeMashApi2.FindTermTreeResponse
```
