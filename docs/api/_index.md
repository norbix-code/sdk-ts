...
**82 endpoints across 9 modules.** Click a module
...
| [`files`](./files.md)              |        10 | File storage integrations and triggers. Upload + download is in `api.database` (FileResource fields).                                    |
